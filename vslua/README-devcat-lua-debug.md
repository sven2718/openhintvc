...
## Terminal Console Option

You can choose where to launch your debug target by adding `console` to your launch configuration:
- `integratedTerminal` runs your program in VS Code’s integrated terminal.
- `externalTerminal` runs your program in a separate terminal window.
